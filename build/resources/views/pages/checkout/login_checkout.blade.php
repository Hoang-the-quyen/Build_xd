...
<div class="w3layouts-main">
	<h2 style="color:white">Đăng nhập</h2>
		<form action="{{URL::to('/login_customer')}}" method="post">
			...
			<input type="password" class="ggg" name="password_account" placeholder="PASSWORD" required="">
			<span><input type="checkbox" />Nhớ mật khẩu</span>
			<h6><a href="#">Quên mật khẩu?</a></h6>
				<div class="clearfix"></div>
				<input type="submit" value="Đăng nhập" name="login">
		</form>
		<p>Bạn chưa có tài khoản ?<a href="{{URL::to('/register_checkout')}}">Đăng ký ngay</a></p>
</div>
</div>
