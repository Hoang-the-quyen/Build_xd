...
<div class="w3layouts-main">
	<h2 style="color:white">Đăng ký</h2>
		<form action="{{URL::to('/add_customer')}}" method="post">
            {{ csrf_field() }}
			<input type="text" class="ggg" name="customer_name" placeholder="NAME" required="">
			<input type="email" class="ggg" name="customer_email" placeholder="E-MAIL" required="">
			<input type="text" class="ggg" name="customer_phone" placeholder="PHONE" required="">
		...
		<p>Bạn đã có tài khoản !<a href="{{URL::to('/login_checkout')}}">Đăng nhập</a></p>
</div>
</div>
