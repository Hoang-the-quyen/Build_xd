        ...
        <section class="panel">
            ...
            <div class="panel-body">
                    ...
                    ?>
                        ...
                        <div class=" form">
                            <form class="cmxform form-horizontal " id="commentForm" method="post" action="{{URL::to('/save-product')}}" enctype="multipart/form-data" novalidate="novalidate">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea rows="8" class="form-control " id="ccomment" name="product_des" required=""></textarea>
                                    </div>
                                </div>
                                {{-- Giá bán --}}
                                <div class="form-group ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="sup_product" class="form-control input-lg m-bot15">
                                            @foreach ($sup_product as $key =>$sup_product )

                                                <option value="{{$sup_product->supplier_id}}">{{$sup_product->supplier_name}}</option>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-3 col-lg-6">
                                        <input type="submit" value="Thêm sản phẩm" name="login">
                                    </div>
                                </div>
                            </form>
                        </div>
